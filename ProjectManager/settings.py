...
SECRET_KEY = 'django-insecure-738j4pu4jur^*^pt^*$=g6*nc(undgi-k4)b76_)g*ry#9y3=h'
...
AUTH_USER_MODEL = 'coreapp.Usuario'
# URL a la que redirigir después de iniciar sesión correctamente
LOGIN_REDIRECT_URL = 'home'

# URL a la que redirigir después de cerrar sesión
LOGOUT_REDIRECT_URL = 'home'

# Configuración para el tamaño máximo de archivo
